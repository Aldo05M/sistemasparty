...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function openQrModal() {
        ...
        if (isMobile()) {
            // SOLO móviles: botón para cámara y fallback para imagen
            ...
            // Fallback: botón para subir imagen
            ...
            requestBtn.onclick = () => {
                ...
                Html5Qrcode.getCameras().then(cameras => {
                    ...
                    let camId = backCam ? backCam.id : (cameras[0].id || { facingMode: { exact: 'environment' } });
                    try {
                        qrScanner = new Html5Qrcode('qr-reader');
                        qrScanner.start(
                            camId,
